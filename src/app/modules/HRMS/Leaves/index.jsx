...
export default (props) => {
  ...
  useEffect(() => {
    dispatch(getLeaveStatisticListAnnual());
  ...
  const leavesPanelHeader = () => (
    <>
      <Row justify="space-between">
        <Col>
          <Title level={4} className="m-0">Annual Leaves</Title>
  ...
  const ListCol = [
    ...
    },
    {
      ...
      key: 'leaves_taken',
      sorted: (a, b) => a.leaves_taken - b.leaves_taken,
      align: 'center',
      width: '100px',
      render: (text) => {
  ...
  return (
    <Row gutter={[24, 30]}>
      ...
      <Col span={24}>
        <Collapse>
          <Panel header={leavesPanelHeader()} key="1" showArrow={false}>
            <ListCard
              onRow={onClickRow}
              ListCol={ListCol}
              ListData={ListData}
